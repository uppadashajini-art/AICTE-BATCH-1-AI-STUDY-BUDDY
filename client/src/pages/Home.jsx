...
export default function Home() {
  const features = [
    ...
    },
    {
      ...
      title: "Upload Notes",
      description:
        "Upload your PDF notes and turn your study material into useful AI-powered resources.",
    },
    {
      icon: <Brain size={30} />,
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Manage your learning resources and follow personalized study plans.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-950 text-white">
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20">
        <div className="relative overflow-hidden bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12">
          {/* Glow */}
          <div className="absolute right-0 top-0 w-72 h-72 bg-purple-600/10 rounded-full blur-3xl"></div>
